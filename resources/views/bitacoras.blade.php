...
@section('title') Bitacoras @endsection

@section('content')

    @component('components.breadcrumb')
        @slot('li_1') Bitacoras @endslot
        @slot('title')  @endslot
    @endcomponent
                                ...
                                <div class="col-xl-8">
                                    <div>
                                        <div class="row align-items-center">
                                            <div class="col-4">
                                                <div>
                                                    <h5 class="mb-0">Lista bitacoras</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                            <h5><a href="blog-details" class="text-dark">Reparacion de refrigerador</a>
                                            </h5>
                                        ...
                                        <div>
                                            <h5><a href="blog-details" class="text-dark">Mantenimiento en beach club</a></h5>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-8">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="list-group list-group-flush">
                                            <a href="blog-details" class="list-group-item text-muted"><i
                                                    class="mdi mdi-circle-medium me-1"></i>Mantenimiento de baños</a>

                                            <a href="blog-details" class="list-group-item text-muted"><i
                                                    class="mdi mdi-circle-medium me-1"></i> Reparacion de tejado</a>

                                            {{--  <a href="blog-details" class="list-group-item text-muted"><i
                                                    class="mdi mdi-circle-medium me-1"></i></a>  --}}
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="list-group list-group-flush">
                                            <a href="blog-details" class="list-group-item text-muted"><i
                                                    class="mdi mdi-circle-medium me-1"></i>Limpieza de almacen</a>
        ...
        <div class="col-xl-3 col-lg-4">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <div>
                        <p class="text-muted mb-2">Bitacoras recientes</p>
