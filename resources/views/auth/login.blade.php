                                ...
                                <div class="d-flex flex-column h-100">
                                    <div >
                                        <a href="index" class="d-block auth-logo">
                                            <img src="{{ URL::asset('/assets/images/tasr.webp') }}" alt="" height="100"
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            <h5 class="text-danger">Bienvenido!</h5>
                                        ...
                                        <div class="mt-4">
                                            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="mt-3 d-grid">
                                                    ...
                                                    style="background-color: crimson" type="submit">Log
                                                        In</button>
                                                </div>
                                            </form>
                                            <div class="mt-5 text-center">
                                                <p>No tienes una cuenta ? <a href=""
                                                        class="fw-medium text-danger" > Registrate </a> </p>
                                            </div>
                                        </div>
                                    </div>
